...
var contraintes = {video: {facesMode: "user"}, audio: false};
...
//diffusez vers la fonction cameraView	  
...
// Démarre le flux vidéo lorsque la fenêtre charge 
window.addEventListener ("charger", cameraStart, false);
